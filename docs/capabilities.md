...
| sdk-navigation | Mini-app-owned screen stacks through the stable `nav` object, with depth hints for system-back coordination and a statically analyzable literal-target graph | openspec/changes/sdk-navigation/specs/sdk-navigation/spec.md |
