...
- An email to `support@whim.anycognition.ca` or a report in the app.
...
- your contact: the Privacy Officer, `support@whim.anycognition.ca`
...
4. A direct reply to anyone who wrote to `support@whim.anycognition.ca` about it, or left contact details in a report.

Say: what happened and when, what information, what Whim has done, and what people can do. Two things they can do themselves: make a new phone ID in Settings, so new records aren't tied to the old one, and turn off AI features or error details in Settings. Give `support@whim.anycognition.ca` for questions. Don't describe a weakness that isn't fixed yet.
