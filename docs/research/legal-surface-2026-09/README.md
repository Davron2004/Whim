...
3. **Who does the text name, and how do people reach you?**
   ...
   - **Owner update (2026-09-24):** the policy and terms name `support@anycognition.ca` as the privacy contact (no separate privacy@ mailbox for now; an alias can replace it later). The street address and phone aren't available yet: the pages render them only once set, and publish with the email contact until then.
