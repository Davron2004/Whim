...
- writes-contract: handoff/admin-contract.md (`ReportStore` interface verbatim, purge scheduling hook, CLI entry module path and subcommand grammar)
- after: chain-2
