...
- [x] 5.2 On-device acceptance (attended, human-run): seeded app → History → restore back and forward → pin → fork-from-old-version → annotations render; record latency observations against #39's numbers
